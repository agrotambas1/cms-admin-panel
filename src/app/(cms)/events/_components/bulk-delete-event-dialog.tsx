...
import { useBulkDeleteEvents } from "@/hooks/event/use-event";
import { useState } from "react";

interface BulkDeleteEventDialogProps {
...
export function BulkDeleteEventDialog({
  selectedIds,
  open,
  onOpenChange,
  onDeleted,
}: BulkDeleteEventDialogProps) {
  ...
  const { loading, bulkDeleteEvents } = useBulkDeleteEvents({
    onSuccess: () => {
      handleClose();
      onDeleted();
    },
