...
export function CardCaseStudy() {
  const { caseStudies, loading, pagination } = useCaseStudies({
    page: 1,
    limit: 1000,
  });
  ...
  const totalCaseStudies = pagination?.total || caseStudies.length;
  ...
  return (
    <Card>
      ...
      <CardContent>
        <div className="text-2xl font-bold">{totalCaseStudies}</div>
